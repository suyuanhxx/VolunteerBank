			...
			<ul>
				...
				<li class="has-sub ">
					...
					<ul class="sub">
						...
						<li ><a href="">我的任务</a></li>
						<li ><a href="../prizeshow.action">积分兑换</a></li>
					</ul>
				</li>
				<li class="has-sub ">
					<a href="javascript:;">
												...
												<div class="tab-content">
													<div id="tab_1-1" class="tab-pane active">
														<div style="height: auto;" id="accordion1-1" class="accordion collapse">
															 <iframe width="800px" height="600px" scrolling="no" frameborder="0" src="../profilemanage.action?username=${user.username}"></iframe>													</div>
													</div>
