...
<html>
  ...
  <body>
  	<div class="header">
  		<div class="pull-left">
  			<span>
				<a href="//www.github.com/suhui" target="_blank"><span class="fa-stack fa-lg">
  		...
  		<div class="pull-right">
	  		...
	  		<a href="#" class="activateOverlay signin"><strong>登陆</strong></a>
	  		<a href="#" class="activateOverlay register"><strong>注册</strong></a>
