	...
	<form action="register.action" method="post" class="form-vertical" >
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-icon left">
					<i class="icon-lock"></i>
					<input class="m-wrap placeholder-no-fix" type="password" id="register_password" placeholder="Password" name="pwd"/>
				</div>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<button id="register-back-btn" type="button" class="btn">
				<a class="popup" href="#" onClick="javascript :history.go(-1);"> 后退 </a>
