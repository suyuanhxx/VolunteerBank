...
<html>
  <head>
   <!-- <base href="<%=path%>"> -->
	...
	<meta http-equiv="Refresh" content="5;url=protected/applytask.jsp">
  ...
  <body class="fixed-top">
	...
	<div class="page-container row-fluid">
		...
		<div class="page-content" style="background-color: #F5F8F8">
			<div class="container-fluid">
				<h2 class="text-center" id="tip"><li class="icon-refresh">  </li></h2>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		window.onload=function(){
			var flag = ${apply};
			if(flag){
				document.getElementById("tip").innerHTML = "恭喜你，成功申请任务，请耐心等待管理员审核！5S后自动跳转";
			}
			else{
				document.getElementById("tip").innerHTML = "你好像已经申请过了，不能重复申请，请耐心等待管理员审核！5S后自动跳转";
			};
		};
	</script>
  </body>
